...
import Svg, { Polygon, Rect, Circle, Path, Line, G, Text as SvgText } from 'react-native-svg';
...
import OfficialStore      from '../screens/subscreens/OfficialStore';
import StudentMarketplace from '../screens/subscreens/StudentMarketplace';
import Messaging          from '../screens/subscreens/Messaging';
import PaymentSystem      from '../screens/subscreens/PaymentSystem';

import AdminPanel     from '../screens/subscreens/AdminPanel';
import Admindashboard from '../screens/subscreens/Admindashboard';
import Adminsettings  from '../screens/subscreens/Adminsettings';
  ...
  return (
    <Svg width={size} height={size} viewBox="-20 -18 40 40">
      ...
      <Path
        ...
        fill={active ? '#dcfce7' : '#f9fafb'} stroke={color} strokeWidth="2" strokeLinecap="round"
      />
      {active && <Circle cx="0" cy="20" r="2.5" fill={DOT_COLOR} />}
    </Svg>
  );
...
export function StudentNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="OfficialStore"      component={OfficialStore}      options={{ headerShown: true, title: 'Official Store',      headerBackTitle: 'Back' }} />
      <Stack.Screen name="StudentMarketplace" component={StudentMarketplace} options={{ headerShown: true, title: 'Student Marketplace', headerBackTitle: 'Back' }} />
      <Stack.Screen name="Messaging"          component={Messaging}          options={{ headerShown: true, title: 'Messages',            headerBackTitle: 'Back' }} />
      <Stack.Screen name="PaymentSystem"      component={PaymentSystem}      options={{ headerShown: true, title: 'Payment',             headerBackTitle: 'Back' }} />
    </Stack.Navigator>
  );
}
...
export function AdminNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="Admindashboard" component={Admindashboard} options={{ headerShown: true, title: 'Dashboard',      headerBackTitle: 'Back' }} />
      <Stack.Screen name="Adminsettings"  component={Adminsettings}  options={{ headerShown: true, title: 'Admin Settings', headerBackTitle: 'Back' }} />
      <Stack.Screen name="Messaging"      component={Messaging}      options={{ headerShown: true, title: 'Messages',       headerBackTitle: 'Back' }} />
    </Stack.Navigator>
  );
}